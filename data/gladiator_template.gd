class_name GladiatorTemplate
extends Resource

## Gladiator-only template. Monsters use MonsterTemplate.
## Owns progression, assignments, lessons, and the full Base/Current Cunning model.
...
func create_runtime_data() -> GladiatorTemplate:
	var runtime := duplicate(true) as GladiatorTemplate
